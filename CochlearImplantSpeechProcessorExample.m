...
% implant speech processors that can be modeled using the 
...
colormap(cochlearfigure, dspcochlearmap);
...
load Stim288.mat
Fs = fs;
newmat=zeros(288,16008);
for i=1:288
    sound = stim(i,:)';
    sim('dspcochlear');
    newmat(i,:)=SynSignal';
end
save('newmat.mat','newmat')
%%
bdclose dspcochlear;
...
%
% Since downsampling is applied at each filter stage, the later stages are
...
% Floating-point version: <matlab:dspcochlear dspcochlear>
%
% Fixed-point version: <matlab:dspcochlear_fixpt dspcochlear_fixpt>
