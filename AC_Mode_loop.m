...
numSounds = 1;%size(stim,1);
avg_FR_ex_A1_time = zeros(numSounds, 16001);
avg_FR_ex_A1_freq = zeros(numSounds, 98);
avg_FR_ex_R_time = zeros(numSounds, 16001);
avg_FR_ex_R_freq = zeros(numSounds, 98);
avg_FR_ex_slow_time = zeros(numSounds, 16001);
avg_FR_ex_slow_freq = zeros(numSounds, 98);
avg_FR_ex_fast_time = zeros(numSounds, 16001);
avg_FR_ex_fast_freq = zeros(numSounds, 98);

% exitatory_spec__A1 = zeros(numSounds, Size-2, 16001);
% exitatory_spec__R = zeros(numSounds, Size-2, 16001);
% exitatory_spec__slow = zeros(numSounds, Size-2, 16001);
% exitatory_spec__fast = zeros(numSounds, Size-2, 16001);
% inhibitory_spec__A1 = zeros(numSounds, Size-2, 16001);
% inhibitory_spec__R = zeros(numSounds, Size-2, 16001);
% inhibitory_spec__slow = zeros(numSounds, Size-2, 16001);
% inhibitory_spec__fast = zeros(numSounds, Size-2, 16001);
...
%         'with Vector Strength = ' num2str(vs_EE4)]);
    ...
    %% end of loop
    %         exitatory_spec__A1(i,:,:) = EE1;
    %         exitatory_spec__R(i,:,:) = EE2;
    %         exitatory_spec__slow(i,:,:) = EE3;
    %         exitatory_spec__fast(i,:,:) = EE4;
    %     inhibitory_spec__A1(i,:,:) = IN1;
    %     inhibitory_spec__R(i,:,:) = IN2;
    %     inhibitory_spec__slow(i,:,:) = IN3;
    %     inhibitory_spec__fast(i,:,:) = IN4;

    avg_FR_ex_A1_time(i,:) = mean(squeeze(EE1),1);
    avg_FR_ex_A1_freq(i,:) = mean(squeeze(EE1),2);
    avg_FR_ex_R_time(i,:) = mean(squeeze(EE2),1);
    avg_FR_ex_R_freq(i,:) = mean(squeeze(EE2),2);
    avg_FR_ex_slow_time(i,:) = mean(squeeze(EE3),1);
...
save(strcat('spectrograms', '.mat'),"avg_FR_ex_fast_freq","avg_FR_ex_fast_time","avg_FR_ex_slow_freq","avg_FR_ex_slow_time", "avg_FR_ex_R_freq","avg_FR_ex_R_time","avg_FR_ex_A1_freq","avg_FR_ex_A1_time")
